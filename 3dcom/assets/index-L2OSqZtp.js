...
#endif`,TA="gl_FragColor = linearToOutputTexel( gl_FragColor );",RA=`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:on,depthTest:!1,depthWrite:!1})}function Yc(){return new Gt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ic(),fragmentShader:`
		...
		`,blending:on,depthTest:!1,depthWrite:!1})}function Kc(){return new Gt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ic(),fragmentShader:`
...
#define LOW_PRECISION`),e}function em(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Zl?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===_u?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Bn&&(e="SHADOWMAP_TYPE_VSM"),e}function tm(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case gi:case Yi:e="ENVMAP_TYPE_CUBE";break;case ia:e="ENVMAP_TYPE_CUBE_UV";break}return e}function nm(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Yi:e="ENVMAP_MODE_REFRACTION";break}return e}function im(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case $l:e="ENVMAP_BLENDING_MULTIPLY";break;case Vu:e="ENVMAP_BLENDING_MIX";break;case Wu:e="ENVMAP_BLENDING_ADD";break}return e}function sm(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function rm(s,e,t,n){const i=s.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=em(t),l=tm(t),h=nm(t),u=im(t),d=sm(t),p=qg(t),m=Xg(r),_=i.createProgram();let f,A,I=t.glslVersion?"#version "+t.glslVersion+`
`:"";t.isRawShaderMaterial?(f=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,m].filter(Ms).join(`
`),f.length>0&&(f+=`
`),A=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,m].filter(Ms).join(`
`),A.length>0&&(A+=`
`)):(f=[cl(t),"#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,m,t.extensionClipCullDistance?"#define USE_CLIP_DISTANCE":"",t.batching?"#define USE_BATCHING":"",t.batchingColor?"#define USE_BATCHING_COLOR":"",t.instancing?"#define USE_INSTANCING":"",t.instancingColor?"#define USE_INSTANCING_COLOR":"",t.instancingMorph?"#define USE_INSTANCING_MORPH":"",t.useFog&&t.fog?"#define USE_FOG":"",t.useFog&&t.fogExp2?"#define FOG_EXP2":"",t.map?"#define USE_MAP":"",t.envMap?"#define USE_ENVMAP":"",t.envMap?"#define "+h:"",t.lightMap?"#define USE_LIGHTMAP":"",t.aoMap?"#define USE_AOMAP":"",t.bumpMap?"#define USE_BUMPMAP":"",t.normalMap?"#define USE_NORMALMAP":"",t.normalMapObjectSpace?"#define USE_NORMALMAP_OBJECTSPACE":"",t.normalMapTangentSpace?"#define USE_NORMALMAP_TANGENTSPACE":"",t.displacementMap?"#define USE_DISPLACEMENTMAP":"",t.emissiveMap?"#define USE_EMISSIVEMAP":"",t.anisotropy?"#define USE_ANISOTROPY":"",t.anisotropyMap?"#define USE_ANISOTROPYMAP":"",t.clearcoatMap?"#define USE_CLEARCOATMAP":"",t.clearcoatRoughnessMap?"#define USE_CLEARCOAT_ROUGHNESSMAP":"",t.clearcoatNormalMap?"#define USE_CLEARCOAT_NORMALMAP":"",t.iridescenceMap?"#define USE_IRIDESCENCEMAP":"",t.iridescenceThicknessMap?"#define USE_IRIDESCENCE_THICKNESSMAP":"",t.specularMap?"#define USE_SPECULARMAP":"",t.specularColorMap?"#define USE_SPECULAR_COLORMAP":"",t.specularIntensityMap?"#define USE_SPECULAR_INTENSITYMAP":"",t.roughnessMap?"#define USE_ROUGHNESSMAP":"",t.metalnessMap?"#define USE_METALNESSMAP":"",t.alphaMap?"#define USE_ALPHAMAP":"",t.alphaHash?"#define USE_ALPHAHASH":"",t.transmission?"#define USE_TRANSMISSION":"",t.transmissionMap?"#define USE_TRANSMISSIONMAP":"",t.thicknessMap?"#define USE_THICKNESSMAP":"",t.sheenColorMap?"#define USE_SHEEN_COLORMAP":"",t.sheenRoughnessMap?"#define USE_SHEEN_ROUGHNESSMAP":"",t.mapUv?"#define MAP_UV "+t.mapUv:"",t.alphaMapUv?"#define ALPHAMAP_UV "+t.alphaMapUv:"",t.lightMapUv?"#define LIGHTMAP_UV "+t.lightMapUv:"",t.aoMapUv?"#define AOMAP_UV "+t.aoMapUv:"",t.emissiveMapUv?"#define EMISSIVEMAP_UV "+t.emissiveMapUv:"",t.bumpMapUv?"#define BUMPMAP_UV "+t.bumpMapUv:"",t.normalMapUv?"#define NORMALMAP_UV "+t.normalMapUv:"",t.displacementMapUv?"#define DISPLACEMENTMAP_UV "+t.displacementMapUv:"",t.metalnessMapUv?"#define METALNESSMAP_UV "+t.metalnessMapUv:"",t.roughnessMapUv?"#define ROUGHNESSMAP_UV "+t.roughnessMapUv:"",t.anisotropyMapUv?"#define ANISOTROPYMAP_UV "+t.anisotropyMapUv:"",t.clearcoatMapUv?"#define CLEARCOATMAP_UV "+t.clearcoatMapUv:"",t.clearcoatNormalMapUv?"#define CLEARCOAT_NORMALMAP_UV "+t.clearcoatNormalMapUv:"",t.clearcoatRoughnessMapUv?"#define CLEARCOAT_ROUGHNESSMAP_UV "+t.clearcoatRoughnessMapUv:"",t.iridescenceMapUv?"#define IRIDESCENCEMAP_UV "+t.iridescenceMapUv:"",t.iridescenceThicknessMapUv?"#define IRIDESCENCE_THICKNESSMAP_UV "+t.iridescenceThicknessMapUv:"",t.sheenColorMapUv?"#define SHEEN_COLORMAP_UV "+t.sheenColorMapUv:"",t.sheenRoughnessMapUv?"#define SHEEN_ROUGHNESSMAP_UV "+t.sheenRoughnessMapUv:"",t.specularMapUv?"#define SPECULARMAP_UV "+t.specularMapUv:"",t.specularColorMapUv?"#define SPECULAR_COLORMAP_UV "+t.specularColorMapUv:"",t.specularIntensityMapUv?"#define SPECULAR_INTENSITYMAP_UV "+t.specularIntensityMapUv:"",t.transmissionMapUv?"#define TRANSMISSIONMAP_UV "+t.transmissionMapUv:"",t.thicknessMapUv?"#define THICKNESSMAP_UV "+t.thicknessMapUv:"",t.vertexTangents&&t.flatShading===!1?"#define USE_TANGENT":"",t.vertexColors?"#define USE_COLOR":"",t.vertexAlphas?"#define USE_COLOR_ALPHA":"",t.vertexUv1s?"#define USE_UV1":"",t.vertexUv2s?"#define USE_UV2":"",t.vertexUv3s?"#define USE_UV3":"",t.pointsUvs?"#define USE_POINTS_UV":"",t.flatShading?"#define FLAT_SHADED":"",t.skinning?"#define USE_SKINNING":"",t.morphTargets?"#define USE_MORPHTARGETS":"",t.morphNormals&&t.flatShading===!1?"#define USE_MORPHNORMALS":"",t.morphColors?"#define USE_MORPHCOLORS":"",t.morphTargetsCount>0?"#define MORPHTARGETS_TEXTURE_STRIDE "+t.morphTextureStride:"",t.morphTargetsCount>0?"#define MORPHTARGETS_COUNT "+t.morphTargetsCount:"",t.doubleSided?"#define DOUBLE_SIDED":"",t.flipSided?"#define FLIP_SIDED":"",t.shadowMapEnabled?"#define USE_SHADOWMAP":"",t.shadowMapEnabled?"#define "+c:"",t.sizeAttenuation?"#define USE_SIZEATTENUATION":"",t.numLightProbes>0?"#define USE_LIGHT_PROBES":"",t.logarithmicDepthBuffer?"#define USE_LOGDEPTHBUF":"","uniform mat4 modelMatrix;","uniform mat4 modelViewMatrix;","uniform mat4 projectionMatrix;","uniform mat4 viewMatrix;","uniform mat3 normalMatrix;","uniform vec3 cameraPosition;","uniform bool isOrthographic;","#ifdef USE_INSTANCING","	attribute mat4 instanceMatrix;","#endif","#ifdef USE_INSTANCING_COLOR","	attribute vec3 instanceColor;","#endif","#ifdef USE_INSTANCING_MORPH","	uniform sampler2D morphTexture;","#endif","attribute vec3 position;","attribute vec3 normal;","attribute vec2 uv;","#ifdef USE_UV1","	attribute vec2 uv1;","#endif","#ifdef USE_UV2","	attribute vec2 uv2;","#endif","#ifdef USE_UV3","	attribute vec2 uv3;","#endif","#ifdef USE_TANGENT","	attribute vec4 tangent;","#endif","#if defined( USE_COLOR_ALPHA )","	attribute vec4 color;","#elif defined( USE_COLOR )","	attribute vec3 color;","#endif","#ifdef USE_SKINNING","	attribute vec4 skinIndex;","	attribute vec4 skinWeight;","#endif",`
`].filter(Ms).join(`
`),A=[cl(t),"#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,m,t.useFog&&t.fog?"#define USE_FOG":"",t.useFog&&t.fogExp2?"#define FOG_EXP2":"",t.alphaToCoverage?"#define ALPHA_TO_COVERAGE":"",t.map?"#define USE_MAP":"",t.matcap?"#define USE_MATCAP":"",t.envMap?"#define USE_ENVMAP":"",t.envMap?"#define "+l:"",t.envMap?"#define "+h:"",t.envMap?"#define "+u:"",d?"#define CUBEUV_TEXEL_WIDTH "+d.texelWidth:"",d?"#define CUBEUV_TEXEL_HEIGHT "+d.texelHeight:"",d?"#define CUBEUV_MAX_MIP "+d.maxMip+".0":"",t.lightMap?"#define USE_LIGHTMAP":"",t.aoMap?"#define USE_AOMAP":"",t.bumpMap?"#define USE_BUMPMAP":"",t.normalMap?"#define USE_NORMALMAP":"",t.normalMapObjectSpace?"#define USE_NORMALMAP_OBJECTSPACE":"",t.normalMapTangentSpace?"#define USE_NORMALMAP_TANGENTSPACE":"",t.emissiveMap?"#define USE_EMISSIVEMAP":"",t.anisotropy?"#define USE_ANISOTROPY":"",t.anisotropyMap?"#define USE_ANISOTROPYMAP":"",t.clearcoat?"#define USE_CLEARCOAT":"",t.clearcoatMap?"#define USE_CLEARCOATMAP":"",t.clearcoatRoughnessMap?"#define USE_CLEARCOAT_ROUGHNESSMAP":"",t.clearcoatNormalMap?"#define USE_CLEARCOAT_NORMALMAP":"",t.dispersion?"#define USE_DISPERSION":"",t.iridescence?"#define USE_IRIDESCENCE":"",t.iridescenceMap?"#define USE_IRIDESCENCEMAP":"",t.iridescenceThicknessMap?"#define USE_IRIDESCENCE_THICKNESSMAP":"",t.specularMap?"#define USE_SPECULARMAP":"",t.specularColorMap?"#define USE_SPECULAR_COLORMAP":"",t.specularIntensityMap?"#define USE_SPECULAR_INTENSITYMAP":"",t.roughnessMap?"#define USE_ROUGHNESSMAP":"",t.metalnessMap?"#define USE_METALNESSMAP":"",t.alphaMap?"#define USE_ALPHAMAP":"",t.alphaTest?"#define USE_ALPHATEST":"",t.alphaHash?"#define USE_ALPHAHASH":"",t.sheen?"#define USE_SHEEN":"",t.sheenColorMap?"#define USE_SHEEN_COLORMAP":"",t.sheenRoughnessMap?"#define USE_SHEEN_ROUGHNESSMAP":"",t.transmission?"#define USE_TRANSMISSION":"",t.transmissionMap?"#define USE_TRANSMISSIONMAP":"",t.thicknessMap?"#define USE_THICKNESSMAP":"",t.vertexTangents&&t.flatShading===!1?"#define USE_TANGENT":"",t.vertexColors||t.instancingColor||t.batchingColor?"#define USE_COLOR":"",t.vertexAlphas?"#define USE_COLOR_ALPHA":"",t.vertexUv1s?"#define USE_UV1":"",t.vertexUv2s?"#define USE_UV2":"",t.vertexUv3s?"#define USE_UV3":"",t.pointsUvs?"#define USE_POINTS_UV":"",t.gradientMap?"#define USE_GRADIENTMAP":"",t.flatShading?"#define FLAT_SHADED":"",t.doubleSided?"#define DOUBLE_SIDED":"",t.flipSided?"#define FLIP_SIDED":"",t.shadowMapEnabled?"#define USE_SHADOWMAP":"",t.shadowMapEnabled?"#define "+c:"",t.premultipliedAlpha?"#define PREMULTIPLIED_ALPHA":"",t.numLightProbes>0?"#define USE_LIGHT_PROBES":"",t.decodeVideoTexture?"#define DECODE_VIDEO_TEXTURE":"",t.logarithmicDepthBuffer?"#define USE_LOGDEPTHBUF":"","uniform mat4 viewMatrix;","uniform vec3 cameraPosition;","uniform bool isOrthographic;",t.toneMapping!==Jn?"#define TONE_MAPPING":"",t.toneMapping!==Jn?ze.tonemapping_pars_fragment:"",t.toneMapping!==Jn?Wg("toneMapping",t.toneMapping):"",t.dithering?"#define DITHERING":"",t.opaque?"#define OPAQUE":"",ze.colorspace_pars_fragment,Vg("linearToOutputTexel",t.outputColorSpace),t.useDepthPacking?"#define DEPTH_PACKING "+t.depthPacking:"",`
`].filter(Ms).join(`
`)),a=Qo(a),a=rl(a,t),a=al(a,t),o=Qo(o),o=rl(o,t),o=al(o,t),a=ol(a),o=ol(o),t.isRawShaderMaterial!==!0&&(I=`#version 300 es
`,f=[p,"#define attribute in","#define varying out","#define texture2D texture"].join(`
`)+`
`+f,A=["#define varying in",t.glslVersion===vc?"":"layout(location = 0) out highp vec4 pc_fragColor;",t.glslVersion===vc?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+A);const C=I+f+a,M=I+A+o,P=il(i,i.VERTEX_SHADER,C),w=il(i,i.FRAGMENT_SHADER,M);i.attachShader(_,P),i.attachShader(_,w),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function B(y){if(s.debug.checkShaderErrors){const L=i.getProgramInfoLog(_).trim(),D=i.getShaderInfoLog(P).trim(),N=i.getShaderInfoLog(w).trim();let z=!0,k=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(z=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,P,w);else{const F=sl(i,P,"vertex"),H=sl(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
`;continue}if((k=z.match(E))&&(N.gamma=parseFloat(k[1])),(k=z.match(y))&&(N.exposure=parseFloat(k[1])),(k=z.match(L))&&(N.valid|=2,N.format=k[1]),(k=z.match(D))&&(N.valid|=4,N.height=parseInt(k[1],10),N.width=parseInt(k[2],10)),N.valid&2&&N.valid&4)break}return N.valid&2||a(3,"missing format specifier"),N.valid&4||a(3,"missing image size specifier"),N},p=function(x,g,E){const y=g;if(y<8||y>32767||x[0]!==2||x[1]!==2||x[2]&128)return new Uint8Array(x);y!==(x[2]<<8|x[3])&&a(3,"wrong scanline width");const L=new Uint8Array(4*g*E);L.length||a(4,"unable to allocate buffer space");let D=0,N=0;const z=4*y,k=new Uint8Array(4),F=new Uint8Array(z);let H=E;for(;H>0&&N<x.byteLength;){N+4>x.byteLength&&a(1),k[0]=x[N++],k[1]=x[N++],k[2]=x[N++],k[3]=x[N++],(k[0]!=2||k[1]!=2||(k[2]<<8|k[3])!=y)&&a(3,"bad rgbe scanline format");let J=0,ne;for(;J<z&&N<x.byteLength;){ne=x[N++];const ee=ne>128;if(ee&&(ne-=128),(ne===0||J+ne>z)&&a(3,"bad scanline data"),ee){const _e=x[N++];for(let Y=0;Y<ne;Y++)F[J++]=_e}else F.set(x.subarray(N,N+ne),J),J+=ne,N+=ne}const ae=y;for(let ee=0;ee<ae;ee++){let _e=0;L[D]=F[ee+_e],_e+=y,L[D+1]=F[ee+_e],_e+=y,L[D+2]=F[ee+_e],_e+=y,L[D+3]=F[ee+_e],D+=4}H--}return L},m=function(x,g,E,y){const L=x[g+3],D=Math.pow(2,L-128)/255;E[y+0]=x[g+0]*D,E[y+1]=x[g+1]*D,E[y+2]=x[g+2]*D,E[y+3]=1},_=function(x,g,E,y){const L=x[g+3],D=Math.pow(2,L-128)/255;E[y+0]=dr.toHalfFloat(Math.min(x[g+0]*D,65504)),E[y+1]=dr.toHalfFloat(Math.min(x[g+1]*D,65504)),E[y+2]=dr.toHalfFloat(Math.min(x[g+2]*D,65504)),E[y+3]=dr.toHalfFloat(1)},f=new Uint8Array(e);f.pos=0;const A=d(f),I=A.width,C=A.height,M=p(f.subarray(f.pos),I,C);let P,w,B;switch(this.type){case yt:B=M.length/4;const x=new Float32Array(B*4);for(let E=0;E<B;E++)m(M,E*4,x,E*4);P=x,w=yt;break;case gt:B=M.length/4;const g=new Uint16Array(B*4);for(let E=0;E<B;E++)_(M,E*4,g,E*4);P=g,w=gt;break;default:throw new Error("THREE.RGBELoader: Unsupported type: "+this.type)}return{width:I,height:C,data:P,header:A.string,gamma:A.gamma,exposure:A.exposure,type:w}}setDataType(e){return this.type=e,this}load(e,t,n,i){function r(a,o){switch(a.type){case yt:case gt:a.colorSpace=xt,a.minFilter=mt,a.magFilter=mt,a.generateMipmaps=!1,a.flipY=!0;break}t&&t(a,o)}return super.load(e,r,n,i)}}class Js{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const wE=new oa(-1,1,1,-1,0,1);class TE extends hn{constructor(){super(),this.setAttribute("position",new ln([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new ln([0,2,0,0,2,0],2))}}const RE=new TE;class ru{constructor(e){this._mesh=new it(RE,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,wE)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}const au={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = opacity * texel;
				...
				}`,blending:uo,depthTest:!1,depthWrite:!1,transparent:!0})}}jn.BlurDirectionX=new xe(1,0);jn.BlurDirectionY=new xe(0,1);class PE extends Js{constructor(e,t,n=null,i=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=i,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new we}render(e,t,n){const i=e.autoClear;e.autoClear=!1;let r,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=i}}const UE={name:"GammaCorrectionShader",uniforms:{tDiffuse:{value:null}},vertexShader:`
		...
		}`};function FE(s,e,t){return new jn(new xe(s.innerWidth,s.innerHeight),e,t)}function NE(s){s.edgeStrength=5,s.edgeGlow=.4,s.edgeThickness=1,s.pulsePeriod=0,s.visibleEdgeColor.set("#ffffff"),s.hiddenEdgeColor.set("#ffffff")}function QE(s,e){e.selectedObjects=[];let t=s.object;e.selectedObjects=[t]}function cu(s){s.selectedObjects=[]}function kE(s,e){e.selectedObjects=[s]}let ti=!0;const Mt=new Dh,OE=new BE;OE.load("spiaggia_di_mondello_1k.hdr",function(s){s.mapping=kr,Mt.environment=s});const Rt=new Fm({antialias:!0});Rt.setPixelRatio(window.devicePixelRatio);Rt.setSize(window.innerWidth,window.innerHeight);Rt.physicallyCorrectLights=!0;Rt.toneMapping=eh;Rt.toneMappingExposure=.9;Rt.outputEncoding=void 0;Rt.shadowMap.enabled=!0;Rt.antialias=!0;container.appendChild(Rt.domElement);let $e,is=new LE(Rt);const GE=new No(Rt),HE=GE.fromScene(new w_(Rt),.04).texture;Mt.environment=HE;Mt.background=new we(16316664);const zE=new l_(16777215,4473924,.1);Mt.add(zE);let $r=new xe;const lu=new M_,Ut=new Ot(40,window.innerWidth/window.innerHeight,.1,100);Ut.position.set(4,8,2);const VE=new PE(Mt,Ut);is.addPass(VE);let ls=FE(window,Mt,Ut);NE(ls);is.addPass(ls);const WE=new ou(UE);is.addPass(WE);const ct=new B_(Ut,Rt.domElement);ct.target.set(0,2.5,0);ct.update();ct.enablePan=!0;ct.enableDamping=!1;document.addEventListener("mousemove",eb,!1);document.addEventListener("mouseup",nb,!1);document.addEventListener("mousedown",tb,!1);document.addEventListener("dblclick",ib,!1);const ni=new IE;ni.setSize(window.innerWidth,window.innerHeight);ni.domElement.style.position="absolute";ni.domElement.style.top="0px";ni.domElement.style.pointerEvents="none";ni.domElement.style.zIndex="10";document.body.appendChild(ni.domElement);const $n=document.getElementById("labelDiv");$n.className="tooltip";const Zs=document.createElement("div");Zs.className="tooltip-header";const ks=document.createElement("h2");ks.textContent="1 דירה";const Os=document.createElement("h3");Os.textContent="קומה 1";const Gs=document.createElement("h3");Gs.textContent="דגם Y.NW";Zs.appendChild(ks);Zs.appendChild(Os);Zs.appendChild(Gs);const $s=document.createElement("div");$s.className="tooltip-icons";const ua=document.createElement("div");ua.className="icon-item";const da=document.createElement("img");da.src="/flower.svg";da.alt="Balcony icon";da.className="icon-svg";const Hs=document.createElement("p");Hs.textContent="מרפסת";ua.appendChild(da);ua.appendChild(Hs);const Aa=document.createElement("div");Aa.className="icon-item";const fa=document.createElement("img");fa.src="/ruler.svg";fa.alt="Size icon";fa.className="icon-svg";const zs=document.createElement("p");zs.textContent='138 מ"ר';Aa.appendChild(fa);Aa.appendChild(zs);const pa=document.createElement("div");pa.className="icon-item";const ga=document.createElement("img");ga.src="/bed.svg";ga.alt="Rooms icon";ga.className="icon-svg";const Vs=document.createElement("p");Vs.textContent="5 חדרים";pa.appendChild(ga);pa.appendChild(Vs);$s.appendChild(ua);$s.appendChild(Aa);$s.appendChild(pa);const ma=document.createElement("div");ma.className="buttons";const hs=document.createElement("button");hs.className="program-btn";const _a=document.createElement("img");_a.src="/plan.svg";_a.alt="Visit Icon";_a.className="icon";hs.appendChild(document.createTextNode(" תוכניות דירה "));hs.appendChild(_a);const us=document.createElement("button");us.className="tour-btn";const Ea=document.createElement("img");Ea.src="/arrow.svg";Ea.alt="Tour Icon";Ea.className="icon";us.appendChild(document.createTextNode(" סיור "));us.appendChild(Ea);document.body.appendChild(hs);document.body.appendChild(us);ma.appendChild(hs);ma.appendChild(us);$n.appendChild(Zs);$n.appendChild($s);$n.appendChild(ma);var ea="https://example.com/visit",ta="https://example.com/tour";let qe,rt={apartment_id:"",rooms:"",Model:"",Floor:"",size:"",balcony:"",availability:"",floorplan_url:"",tour_url:""},Ws=!1,qs=!1;document.addEventListener("keydown",qE,!1);function qE(s){var e=s.which;e==49?window.selectApartment(1):e==50?window.selectApartment(2):e==51?window.selectApartment(3):e==52?window.selectApartment(4):e==53&&window.selectApartment(5)}const XE=new fn().setTranscoderPath("jsm/libs/basis/").detectSupport(Rt),Wn=new T_;Wn.setCrossOrigin("anonymous");Wn.setKTX2Loader(XE);Wn.setMeshoptDecoder(vE);const YE=new URLSearchParams(window.location.search),Lr=YE.get("building");Lr=="0"?Wn.load("./house7.glb",function(s){$e=s.scene,$e.position.set(0,-.1,0),$e.scale.set(.1,.1,.1),$e.traverse(function(e){e.frustumCulled=!1}),Mt.add($e),vs.parse("./data.csv",{delimiter:"",newline:"",download:!0,header:!0,complete:function(e){qe=e.data,Is()}})},void 0,function(s){console.error(s)}):Lr=="1"?Wn.load("./scene_newBuilding_v2.glb",function(s){$e=s.scene,$e.position.set(0,-.1,0),$e.scale.set(.1,.1,.1),$e.traverse(function(e){e.frustumCulled=!1}),Mt.add($e),vs.parse("./datav2.csv",{delimiter:"",newline:"",download:!0,header:!0,complete:function(e){qe=e.data,Is()}})},void 0,function(s){console.error(s)}):Lr=="2"?Wn.load("./scene_building_prod_v6.glb",function(s){$e=s.scene,$e.position.set(0,-.1,0),$e.scale.set(.1,.1,.1),$e.traverse(function(e){e.frustumCulled=!1}),Mt.add($e),vs.parse("./data_prod_updated.csv",{delimiter:"",newline:"",download:!0,header:!0,complete:function(e){qe=e.data,Is()}})},void 0,function(s){console.error(s)}):Lr=="3"?Wn.load("./scene_building_prod_v5.glb",function(s){$e=s.scene,$e.position.set(0,-.1,0),$e.scale.set(.1,.1,.1),$e.traverse(function(e){e.frustumCulled=!1}),Mt.add($e),vs.parse("./data_prod_updated.csv",{delimiter:"",newline:"",download:!0,header:!0,complete:function(e){qe=e.data,Is()}})},void 0,function(s){console.error(s)}):Wn.load("./ExportV4.glb",function(s){$e=s.scene,$e.position.set(0,-.1,0),$e.scale.set(.1,.1,.1),$e.traverse(function(e){e.frustumCulled=!1}),Mt.add($e),vs.parse("./data_prod_updated_v2.csv",{delimiter:"",newline:"",download:!0,header:!0,complete:function(e){qe=e.data,Is()}})},void 0,function(s){console.error(s)});const KE=document.getElementById("compass-needle");function jE(){const s=new U;Ut.getWorldDirection(s);const e=Math.atan2(s.x,s.z);let t=ra.radToDeg(e);return t<0&&(t=360+t),t}function JE(){const s=jE();KE.style.transform=`rotate(${-s}deg)`}function ZE(){if(!ti){er&&ob(),Xs&&ab(),Ut.updateMatrixWorld();var s=new U,e=new U;s.set(200/window.innerWidth*2-1,-(200/window.innerHeight)*2+1,.5),s.unproject(Ut),s.sub(Ut.position).normalize();var t=-Ut.position.z/s.z;e.copy(Ut.position).add(s.multiplyScalar(t)),JE(),Rt.render(Mt,Ut),is.render(),ni.render(Mt,Ut)}}Rt.setAnimationLoop(ZE);window.onresize=function(){Ut.aspect=window.innerWidth/window.innerHeight,Ut.updateProjectionMatrix(),Rt.setSize(window.innerWidth,window.innerHeight),ni.setSize(window.innerWidth,window.innerHeight),is.setPixelRatio(Math.min(window.devicePixelRatio,2)),is.setSize(window.innerWidth,window.innerHeight)};function Is(){$e.traverse(s=>{if(s.isMesh){if(s.material){const e=s.material;if(e.isMeshStandardMaterial||e.isMeshPhysicalMaterial)e.metalness=e.metalness??.5,e.roughness=e.roughness??.5,e.emissiveIntensity=e.emissiveIntensity??1.5,e.name.includes("M_Windows_Day")&&(e.emissiveIntensity=2,e.roughness=.1),e.needsUpdate=!0;else{const t=new Zn({map:e.map,normalMap:e.normalMap,metalnessMap:e.metalnessMap,roughnessMap:e.roughnessMap,emissive:e.emissive,emissiveMap:e.emissiveMap,emissiveIntensity:e.emissiveIntensity,metalness:e.metalness||.5,roughness:e.roughness||.5});child.material=t}}if(s.name.includes("apart")){for(let e=0;e<qe.length;e++)if(s.name.replace("apartment_","")==qe[e].apartment_id){let t;qe[e].availability=="available"?t=new Zn({color:new we("rgb(137, 211, 255)"),metalness:0,roughness:0,transparent:!0,opacity:.2}):t=new Zn({color:new we("rgb(255, 118, 197)"),metalness:0,roughness:0,transparent:!0,opacity:.2}),s.material=t}}}}),ti=!1}const $E=new f_(16777215,2);Mt.add($E);const hu=new Qh(16777215,1);hu.position.set(10,10,10);Mt.add(hu);const uu=new cc(16777215,.8);uu.position.set(5,5,5);Mt.add(uu);function eb(s){if(ti||qs)return;$r=kh(s,window),Ls=!0;const e=!0;$e.traverse(i=>{i.isMesh&&i.name.includes("apart")&&i.userData.isSelected!=!0&&(i.material.transparent=!0,i.material.opacity=.2)});const t=Oh($r,Ut,lu,Mt,e,!1);let n=!1;if(t)for(let i=0;i<qe.length;i++)t.object.name.replace("apartment_","")===qe[i].apartment_id.toString()&&(ks.textContent="דירה "+qe[i].apartment_id,Vs.textContent="חדרים: "+qe[i].rooms,Gs.textContent="דגם "+qe[i].Model,Os.textContent="קומה: "+qe[i].Floor,zs.textContent="מ״ר "+qe[i].size,Hs.textContent="מרפסת "+qe[i].balcony,$n.className="tooltip show",n=!0,ea=qe[i].floorplan_url,ta=qe[i].tour_url);else Ws?(ks.textContent="דירה "+rt.apartment_id,Vs.textContent="חדרים: "+rt.rooms,Gs.textContent="דגם "+rt.Model,Os.textContent="קומה: "+rt.Floor,zs.textContent="מ״ר "+rt.size,Hs.textContent="מרפסת "+rt.balcony,$n.className="tooltip show",ea=rt.floorplan_url,ta=rt.tour_url):!n&&!Ws&&($n.className="tooltip hide")}var qn,er=!1;window.closeApartment=function(){ti||cu(ls)};window.selectApartment=function(s){ti||$e.traverse(e=>{if(e.isMesh&&e.name.includes("apart")){let t=s-1;e.userData.isSelected&&(e.userData.isSelected=!1,Ws=!1),e.name.replace("apartment_","")===qe[t].apartment_id.toString()&&(Ws=!0,e.userData.isSelected=!0,e.material.transparent=!0,e.material.opacity=.38,kE(e,ls),ks.textContent="דירה "+qe[t].apartment_id,Vs.textContent="חדרים: "+qe[t].rooms,Gs.textContent="דגם: "+qe[t].Model,Os.textContent="קומה: "+qe[t].Floor,zs.textContent="מ״ר "+qe[t].size,Hs.textContent="מרפסת "+qe[t].balcony,$n.className="tooltip show",rt.apartment_id=qe[t].apartment_id,rt.rooms=qe[t].rooms,rt.Model=qe[t].Model,rt.Floor=qe[t].Floor,rt.size=qe[t].size,rt.balcony=qe[t].balcony,rt.availability=qe[t].availability,rt.floorplan_url=qe[t].floorplan_url,rt.tour_url=qe[t].tour_url,ea=qe[t].floorplan_url,ta=qe[t].tour_url,er=!0)}})};let Ls=!1;function tb(s){ti||(Ls=!1,qs=!0)}function nb(s){if(ti)return;if(qs=!1,Ls){Ls=!1;return}Ls=!1,$r=kh(s,window);const t=Oh($r,Ut,lu,Mt,!0,!0);if(t&&t.object.name.includes("apart")){QE(t,ls);var n=new U;if(parent){let r=t.object.name.replace("apartment_","");parent.selectApartment(r)}t.object.geometry.boundingBox.getCenter(n),t.object.localToWorld(n),n=new U(t.object.position.x,t.object.position.y,t.object.position.z),er=!0;var i=new U;i=i.angleTo(n),n.x>=0&&n.z>=0?qn=1.2:n.x>=0&&n.z<0?qn=2.2:n.x<0&&n.z>=0&&n.z<.5?qn=-1.6:n.x<0&&n.z>=.8?qn=-.7:n.x<0&&n.z<0&&(qn=-2.2)}}function ib(s){ti||qs||($e.traverse(e=>{e.isMesh&&e.name.includes("apart")&&e.name.includes(rt.apartment_id)&&(e.userData.isSelected=!1,Ws=!1,qs=!1,rt.apartment_id=null,rt.rooms=null,rt.Model=null,rt.Floor=null,rt.size=null,rt.balcony=null,rt.availability=null,cu(ls))}),na=0,Xs=!0)}let sb=ct.minAzimuthAngle,rb=ct.maxAzimuthAngle,na=0,Xs=!1;document.getElementById("compass-container").addEventListener("click",function(){na=0,Xs=!0});hs.addEventListener("click",function(){const s=document.getElementById("iframePopup");s.src=ea,new bootstrap.Modal(document.getElementById("iframeModal")).show()});us.addEventListener("click",function(){const s=document.getElementById("iframePopup");s.src=ta,new bootstrap.Modal(document.getElementById("iframeModal")).show()});function ab(){if(!Xs)return;let s=ct.getAzimuthalAngle(),e=ra.lerp(s,na,.05);ct.minAzimuthAngle=e,ct.maxAzimuthAngle=e,ct.update(),Math.abs(e-na)<.01&&(Xs=!1,ct.minAzimuthAngle=-1/0,ct.maxAzimuthAngle=1/0,ct.update())}function ob(){function s(n,i,r){return n+r*(i-n)}var e=ct.getAzimuthalAngle();ct.minAzimuthAngle=s(e,qn,.1),ct.maxAzimuthAngle=ct.minAzimuthAngle,ct.update();const t=.01;Math.abs(e-qn)<t&&(e=qn,er=!1,ct.minAzimuthAngle=1/0,ct.maxAzimuthAngle=1/0,ct.update()),Math.abs(e-.5)<t&&cb()}function cb(s){ct.minAzimuthAngle=sb,ct.maxAzimuthAngle=rb,er=!1}
